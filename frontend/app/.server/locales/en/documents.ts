const ns = {
  index: {
    ...
    uploadDocuments: "Upload more documents",
  ...
  upload: {
    ...
    fileAddedAnnouncement_one: "File “{{fileName}}” was added successfully.",
    fileAddedAnnouncement_other: "{{count}} files were added successfully.",
    fileRemovedAnnouncement_one: "File “{{fileName}}” was removed successfully.",
    fileRemovedAnnouncement_other: "{{count}} files were removed successfully.",
    submit: "Submit",
