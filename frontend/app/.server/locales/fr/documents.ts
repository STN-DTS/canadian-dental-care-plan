const ns = {
  index: {
    ...
    uploadDocuments: "Téléverser plus de documents",
  ...
  upload: {
    ...
    fileAddedAnnouncement_one: "Le fichier «\u00A0{{fileName}}\u00A0» a été ajouté avec succès.",
    fileAddedAnnouncement_other: "{{count}} fichiers ont été ajoutés avec succès.",
    fileRemovedAnnouncement_one: "Le fichier «\u00A0{{fileName}}\u00A0» a été supprimé avec succès.",
    fileRemovedAnnouncement_other: "{{count}} fichiers ont été supprimés avec succès.",
    submit: "Soumettre",
