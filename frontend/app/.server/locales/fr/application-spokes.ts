const ns = {
  ...
  applicationDelegate: {
    pageTitle: "Présenter une demande au nom d'une autre personne",
    beforeSubmit: "Avant de soumettre une demande au nom d'une autre personne, vous devez fournir une preuve démontrant que vous êtes autorisé à agir en son nom à titre de\u00A0:",
    legalRepresentative: "représentant légal",
    powerOfAttorney: "titulaire d'une procuration",
    mandate: "mandataire",
    trusteeship: "tuteur",
    ...
    detail: {
      additionalInfo: {
        list: {
          ...
          premium: "vous devez payer une prime pour en bénéficier",
          notCovered: "vous n'êtes pas couvert par l'assurance ou la couverture dentaire privée pour les soins dentaires",
          optedAfter: "vous avez renoncé à l'assurance dentaire de votre régime de retraite après le 11 décembre 2023 (que vous puissiez y réadhérer ou non)",
          optedBefore: "vous avez renoncé à l'assurance dentaire de votre régime de retraite avant le 11 décembre 2023 et qu'il est possible d'y adhérer de nouveau",
        },
  ...
  personalInformation: {
    ...
    errorMessage: {
      ...
      alert: {
        ...
        applyDate:
          "<strong>Remarque\u00A0:</strong> Seuls les participants actuels du RCSD peuvent renouveler leur adhésion dès maintenant. Si vous ne participez pas déjà au RCSD, vous pourrez présenter une demande d'adhésion pour la prochaine année de couverture à compter du <startDate />.",
      },
    },
  },
  dentalBenefits: {
