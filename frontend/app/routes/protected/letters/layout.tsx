...
import { programApplicantMiddleware } from '~/middlewares/applicant.server';
 ...
 */
export const middleware: Route.MiddlewareFunction[] = [createFeatureMiddleware('view-letters'), programApplicantMiddleware];
