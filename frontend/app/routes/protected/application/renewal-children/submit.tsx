...
import { useFeature, useFetcherSubmissionState, useHCaptcha } from '~/hooks';
...
export async function loader({ context, params, url }: Route.LoaderArgs) {
  ...
  const state = loadProtectedApplicationRenewalChildStateForReview({ params, requestUrl: url, session });
