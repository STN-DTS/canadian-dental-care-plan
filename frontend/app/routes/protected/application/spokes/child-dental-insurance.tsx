          ...
          <fetcher.Form method="post" noValidate>
            ...
            <div className="my-6">
              <div className="mb-4 space-y-4">
                ...
                <p>
                  <Trans ns="protectedApplicationSpokes" i18nKey={($) => $.children.dentalInsurance.detail.additionalInfo.note} values={{ childName }} />
                </p>
                <p>
                  <Trans ns="protectedApplicationSpokes" i18nKey={($) => $.children.dentalInsurance.detail.additionalInfo.socialProgram} values={{ childName }} />
                </p>
                <p>
                  <Trans
              ...
              <p className="my-8 italic">{t(($) => $.requiredLabel, { ns: 'protectedApplication' })}</p>
              <InputRadios
