          ...
          <fetcher.Form method="post" noValidate>
            ...
            <div className="my-6">
              <div className="mb-4 space-y-4">
                ...
                <p>
                  <Trans ns="protectedApplicationSpokes" i18nKey={($) => $.dentalInsurance.detail.additionalInfo.note} />
                </p>
                <p>
                  <Trans ns="protectedApplicationSpokes" i18nKey={($) => $.dentalInsurance.detail.additionalInfo.socialProgram} />
                </p>
                <p>
                  <Trans
